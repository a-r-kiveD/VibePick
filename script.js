...
document.addEventListener('DOMContentLoaded', () => {
    ...
    handleTravelLogic = function() {
     ...
     handleDineoutLogic = function() {
        ...
        let emoji = "🍽️";
        let message = "Chef's Special!";
        let suggestion = "";

        if (diet === "spicy") {
            emoji = "🌶️";
            suggestion = "Try Spicy Chicken Wings or Hot Schezwan Noodles!";
        } 
        else if (diet === "dessert") {
            emoji = "🍨";
            suggestion = "Go for Chocolate Lava Cake or Vanilla Ice Cream Sundae!";
        } 
        else if (diet === "nonveg") {
            emoji = "🍗";
            suggestion = "Try Fried Chicken or Grilled Beef Steak!";
        } 
        else {
            emoji = "🍕";
            suggestion = "Try the Signature Platter!";
        }

        showResult(emoji, message, suggestion);
    };
